...
export const MODULE_ID = 'pf2e-dailies-ext'
...
monaco.languages.typescript.javascriptDefaults.addExtraLib(types, typesUri)
monaco.editor.createModel(types, 'typescript', monaco.Uri.parse(typesUri))
