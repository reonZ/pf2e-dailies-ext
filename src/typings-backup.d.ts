...
type DailyUtils = {
     ...
     */
    createSkillRuleElement: ({ skill, value, mode = 'upgrade', predicate }: CreateSkillArgs) => AELikeSource
    /**
     ...
     */
    createLanguageRuleElement: ({ language, mode = 'add', predicate }: CreateLanguageArgs) => AELikeSource
    /**
     ...
     */
    createResistanceRuleElement: ({ type, value, predicate }: CreateResistanceArgs) => IWRRuleElementSource
    /**
     ...
     */
    createSpellScrollSource: ({ uuid, level }: CreateScrollArgs) => Promise<ConsumableSource>
    /**
...
declare class Dialog {
    ...
    static prompt(options?: PromptDialogParamters): Promise<any>
}
